...
// CoreAudio placeholder implementation for macOS.
// This file provides a platform-specific audio backend implementation stub
// so the project builds on macOS. A full CoreAudio implementation can be
// added here in the future; for now this mirrors the non-Windows stub
// behaviour but is compiled only on Apple platforms.
...
{
    // CoreAudio backend is not implemented yet; report as unavailable.
    setStatus("CoreAudio backend not implemented; microphone not available");
...
{
    setStatus("CoreAudio backend not implemented");
    return false;
}
