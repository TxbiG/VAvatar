...
Shader::Shader(const char* vertexFile, const char* fragmentFile)
{
	...
	glAttachShader(ID, vertexShader);				// Attach the Vertex Shaders to the Shader Program
	glAttachShader(ID, fragmentShader);				// Attach the Fragment Shaders to the Shader Program
